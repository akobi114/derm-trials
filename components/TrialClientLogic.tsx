...
import { 
  ...
  FlaskConical, CheckCircle2, Share2 
} from 'lucide-react';
    ...
    if (isRecruiting) {
      return (
        <>
          ...
          {/* MODAL IS RENDERED HERE WHEN OPEN */}
          {isModalOpen && (
                ...
                <div className="p-6 overflow-y-auto">
                  ...
                  {screenerStep === 'quiz' && (
                    <div className="space-y-6">
                      ...
                      <button onClick={handleQuizCheck} disabled={!trial.screener_questions || Object.keys(answers).length < trial.screener_questions.length} className="w-full bg-slate-900 text-white py-3.5 rounded-xl font-bold hover:bg-slate-800 transition-colors disabled:opacity-50 mt-4">Check Results</button>
                    </div>
                  )}
